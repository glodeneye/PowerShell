...
.PARAMETER HostTenantDomain
    The primary tenant domain (e.g., compliancerisk.io)

.PARAMETER GuestTenantDomain
    The secondary tenant domain to invite users from (e.g., pelican3.net)
...
.EXAMPLE
    .\Setup-CrossTenantCollaboration.ps1 -HostTenantDomain "compliancerisk.io" `
...
"@
    ...
    $html += @"
        ...
        <div class="footer">
            ...
            ComplianceRisk.io | $(Get-Date -Format "yyyy-MM-dd HH:mm:ss")
        </div>
    </div>
</body>
</html>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            ComplianceRisk.io | M365 Cross-Tenant Setup Script v2.0<br>
